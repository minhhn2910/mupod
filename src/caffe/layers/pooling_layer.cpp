...
template <typename Dtype>
std::pair<Dtype, Dtype*> PoolingLayer<Dtype>::BackwardError_cpu(const vector<Blob<Dtype>*>& top,
    ...
    default:
      ...
      Dtype result[] = {0.0};
      std::cout <<"pooling multiply factor "<<multiply_factor<<"\n";
...
template <typename Dtype>
std::pair<Dtype, Dtype*> PoolingLayer<Dtype>::BackwardError_gpu(const vector<Blob<Dtype>*>& top,
    const vector<bool>& propagate_down,
    const vector<Blob<Dtype>*>& bottom,const Dtype delta_top, const Dtype W_portion ) {
